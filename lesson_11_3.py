...
# проверку типа элемента. Вносить его в список, только если введено число. Класс-
# исключение должен не позволить пользователю ввести текст (не число) и отобразить
# соответствующее сообщение. При этом работа скрипта не должна завершаться.


class txt_exception(Exception):
    def __init__(self, txt):
        self.txt = txt
res_list = []
flag = True
while flag == True:
  inp_data = input('Введите элемент списка: ')
  if inp_data == 'stop':
    flag = False
    print(res_list)
    break
